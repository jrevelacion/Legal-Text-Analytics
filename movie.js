...
const MOVIE_ENDPOINTS = [
    ...
    { url: 'https://vidfast.pro/movie/', name: 'Epic(No Ads)' },
...
const fetchMovieDetails = async () => {
    try {
        ...
        // Fetch Movie Cast (Leading Actors)
        ...
        // Example: Loop through cast and append actors
        castData.cast.slice(0, 9).forEach(actor => { // Limit to 6 actors
...
const fetchMoreLikeThis = async (movieId) => {
    try {
        ...
        const similarMoviesContainer = document.getElementById('similar-shows-container');
        ...
        data.results.forEach(movie => {
            ...
            movieItem.classList.add('similar-show'); // Add the grid item class
            ...
            movieImage.classList.add('similar-show-img'); // Add the image class
